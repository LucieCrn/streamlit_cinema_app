...
import pandas as pd
import os #TO-DO Pensez à passer les chemin en relatif quand tout sera bien dans un dossier. 
...
# OUTILS DE SELECTION - INTERRACTION AVEC L'UTILISATEUR
    ...
    with col3 : 
        choix_affiche = st.selectbox("Afficher les affiches des films", ["Non", "Oui"])
